...
tips-dataset-175 = Sector Crescent is made up of six systems, and is divvied up into the Core and Outer Rim districts in terms of governance. The systems Chengridz, Porodschok and Malpais making up the NCWL-controlled Core, while Taypan and Domain make up the contested Outer Rim."
tips-dataset-176 = Hullrot refers to an entropic decay of a vessel's vibroplasteel hull alloy, most commonly seen in Hadal Deepdiver vessels as a result of exotic particles from the Fog acting as rapid oxidizers against the metal content of a vessel's outer plating."
tips-dataset-177 = Imperial society is driven by religious fervor in the form of canonized Saints. Those recognized by the Saintsworn faith as having lived remarkable and faithful lives are often post-humously canonized in death."
tips-dataset-178 = The Imperial Charter of Scribes is the arm of House Kircheis tasked with developing new technologies for their liege in both Imperial military and civilian applications."
tips-dataset-179 = Lepidopods and arachnopods, despite being different races, are collectively called Atyrians by the Imperial Supercluster and the Crescent."
tips-dataset-180 = In 101 BBSC (Before Bluespace Collapse), the Crescent United Worker’s Front is formed to demand humane treatment for plasma extractors laboring in servitude to the Divine Sol Mandate."
tips-dataset-181 = The Battle for Chengridz (81-78 BBSC) culminates in the NCWL seizing the sector’s largest stores of plasma as well as the warp-gates leading in and out of the system."
tips-dataset-182 = Trade goods can be purchased at a station’s Dispensary, Commissary or manufactured using Commodity Fabricators and then sold for a profit at other stations."
tips-dataset-183 = Trade goods are delivered to a Turn-in Chute in exchange for a credit deed that can be redeemed at a Deed Console."
tips-dataset-184 = Each station has a unique list of trade goods that can be purchased or produced from materials."
tips-dataset-185 = The Taypan system once had three planets. The Authoritat's 43rd Battlegroup arrived. Today it only has two."
tips-dataset-186 = A Mass Scanner and GPS is always useful in Taypan. Veteran Spacers vouchsafe that they keep the Fog away."
tips-dataset-187 = Love blooms."
tips-dataset-188 = Kane whispers in the dreams of some within Taypan. For a select few, he issues orders."
tips-dataset-189 = Within each flesh beast melded by the Hadal, there is a microchip. Cut them out."
tips-dataset-190 = The chances of being murdered by your coworkers are low, but never zero."
tips-dataset-191 = Shinohara Heavy Industries operates a branch within Taypan at the Tatsumoto Shipyard. Their relatively up-to-date technology chips produce everything the contested System desires, for a price."
tips-dataset-192 = The New Crescent Syndicate of Privateers (NCSP) quickly collapsed with the disappearance of Sir William 'Pincer' Moore, the closest recent successor is the Taypan Free Stations Coalition (TFSC). Which has splintered apart even further."
tips-dataset-193 = The Domain, once the only uncontested Divine Sol Mandate system within Sector Crescent is now under occupation of the Authoritat's 43rd Battlegroup. Few refugees consider to escape to Taypan, knowing conditions to be grimly worse."
tips-dataset-194 = The 6th St. Romaine's Militia is still spoken of by hushed voices. Speaking their name is said to draw them near, often used as a phenomenal curse against Atyrians."
tips-dataset-195 = The Hadal Tide periodically scourges the entirety Taypan with energies unknown to mankind. It's currents are unpredictable and malevolent. Only thick layers of reinforced plastitanium hull are proof against it. Well. Most of it."
tips-dataset-196 = In the psychic world, promises and belief holds power. With a sufficient amount of strong psychic imprint from a sufficient amount of sapients, manifestations can be made reality through sheer force of will, and pacts made with these apparitions are often upheld to the last detail."
tips-dataset-197 = The New Liberation Front are a group formed of NCWL dissidents disgruntled by power struggles and coups. Operating out of converted civilian craft they have ambushed many Homeguard vessels during inspections."
tips-dataset-198 = Reports show long-term EVA in Taypan can lead to a multitude of medical conditions, including but not limited to, rot contamination in lungs, uncontrollable bleeding, and death."
tips-dataset-199 = After the breaking up of Kal Surezai by the 43rd Battlegroup, a number of Knights and Dames lost contact with their lieges. These Remnants continue serving their oaths or desires within the 'hedges' of Taypan, living on jerry rigged supplies and equipment."
tips-dataset-200 = The Divine Sol Mandate's House of Questions has a policy of recording all psionics within Mandate territories."
tips-dataset-201 = Nanotrasen brand Cigarettes are rumoured to be made from a mythical elixir of life, kept solely in-house and within executives hands as boons to employees. Nanotrasen fog wrecks are the only known holders of these exquisite packs of ten."
tips-dataset-202 = Pang Tai Arms strategy to counter Shinohara's great quantity with quality, taking stable experimental weapons designs to market has made a dangerous rival to Shinohara and its unmarked Liquidators."
tips-dataset-203 = Pax America lives on but written small in the New American Protectorate (NAP), secured in New Washington, far from Sector Crescent. Through suave diplomacy and a fleet capable of punching above its weight, its citizens has retained its somewhat peace through the ages of Strife and Broken Chains."
tips-dataset-204 = Sol, the highest throne of Mandate power was abruptly up-turned when the Coup restructured the the core systems into the Central Solarian Authoritat. Complacent and titled noble necks were bent back from the knives of their ambitious lieutenants and the invulnerable Kaiser was revealed as a human corpse."
tips-dataset-205 = The Atyrian diaspora spread across the imperial sphere until they were collected, by the Kaiser's command, into the Atyrian Preserve."
tips-dataset-206 = The Officers Coup in Sol spun the greater Divine Sol Mandate into a state of confusion and civil war, Kaiserin Tadia Guies II has the systems about Kyotr's Rest back within the Imperial grasp. Too far away to aid Taypan but hope can shine a miraculous distance."
tips-dataset-207 = The NCWL's state sponsored language evolved from early dockworkers' canto, bridging the gap between species, profession and culture for the sake of industrial quota."
tips-dataset-208 = Taypan and the Sector Crescent has been cut off from the Imperial Supercluster until very recently. The several hundred years of isolation has changed everything and yet nothing. Sector Crescent remains a trap to all who enter."
tips-dataset-209 = If you're on fire, you can click the alert on the right of your screen to stop, drop, and roll."
tips-dataset-210 = You can view and edit all keybindings used in-game at any time through the Options menu."
tips-dataset-211 = You can access the in-game guidebook through the escape menu, or by pressing Numpad 0 by default."
tips-dataset-212 = some entities ingame have guidebook entries associated with them, which you can view by examining the entity and clicking the question mark icon."
tips-dataset-213 = Artifacts have the ability to gain permanent effects for some triggered nodes, including becoming an intercom or an extremely efficient generator."
tips-dataset-214 = You can avoid slipping on most puddles by walking. However, some strong chemicals like space lube will slip people anyway."
tips-dataset-215 = You can use the Activate in World keybind, E by default, to interact with objects while your hands are full, or without picking them up."
tips-dataset-216 = Common sense goes a long way to avoiding conflict."
tips-dataset-217 = Chemicals don't react while inside the ChemMaster's buffer."
tips-dataset-218 = You can hold SPACE by default to slow the movement of the shuttle when piloting, to allow for precise movements--or even coming to a complete stop."
tips-dataset-219 = You can add labels to any item, including food or pill canisters, using a hand labeller."
tips-dataset-220 = As a ghost, you can use the Verb Menu to orbit around and follow any entity in game automatically."
tips-dataset-221 = You can examine your headset to see which radio channels you have available and how to speak in them."
tips-dataset-222 = You'll quickly lose your interest in the game if you play to win and kill. If you find yourself doing this, take a step back and talk to people--it's a much better experience!"
tips-dataset-223 = If there's something you need from another department, try asking! This game isn't singleplayer and you'd be surprised what you can get accomplished together!"
tips-dataset-224 = All forms of toxin damage are fairly difficult to treat, and usually involve the use of chemicals or other inconvenient methods. You can use this to your advantage in combat."
tips-dataset-225 = Speed is almost everything in combat. Using hardsuits just for their armor is usually a terrible idea unless the resistances it provides are geared towards combat, or you're not planning to go head-first into the fray."
tips-dataset-226 = You can spray a fire extinguisher, throw items or fire a gun while floating through space to give yourself a minor boost. Simply fire opposite to where you want to go."
tips-dataset-227 = You can drag other players onto yourself to open the strip menu, allowing you to remove their equipment or force them to wear something. Note that exosuits or helmets will block your access to the clothing beneath them, and that certain items take longer to strip or put on than others."
tips-dataset-228 = You can climb onto a table by dragging yourself onto one."
tips-dataset-229 = You can move an item out of the way by dragging it, and then holding CTRL + right click and moving your mouse into the direction you want it to go."
tips-dataset-230 = Burn damage, such as that from a welding tool or lightbulb, can be used to cauterize wounds and stop bleeding."
tips-dataset-231 = Bleeding is no joke! If you've been shot or acquired any other major injury, make sure to treat it quickly."
tips-dataset-232 = In an emergency, you can butcher a jumpsuit with a sharp object to get cloth, which can be crafted into gauze."
tips-dataset-233 = You can use sharp objects to butcher clothes or animals in the right click context menu. This includes glass shards."
tips-dataset-234 = You can click on the names of items to pick them up in the right click menu, instead of hovering over the item and then selecting pick up."
tips-dataset-235 = Space Station 14 is open source! If there's a change you want to make, or a simple item you want to add, then try contributing to the game. It's not as hard as you'd think it is."
tips-dataset-236 = Some weapons, such as knives & shivs, have a fast attack speed."
tips-dataset-237 = The jaws of life can be used to open powered doors."
tips-dataset-238 = There is a chemical metabolism limit that limits the amount of reagents of a certain type you can digest at once. Certain species have higher metabolism limits, such as slimes."
tips-dataset-239 = Welding without proper eye protection can cause eye damage, which must be cured with oculine."
tips-dataset-240 = You can weld glass shards into glass sheets."
tips-dataset-241 = By right clicking on a player, and then clicking the heart icon, you can quickly examine them to check for injuries or how badly they're bleeding. You can also do this to yourself."
tips-dataset-242 = You can tell if an area with firelocks up is spaced by looking to see if the firelocks have lights beside them."
tips-dataset-243 = Instead of picking it up, you can alt-click food to eat it. This also works for mice and other creatures without hands."
tips-dataset-244 = If you have the CPR Training trait, or are any medical doctor, you can perform CPR by right clicking someone who is dead or in critical condition."
tips-dataset-245 = CPR can occasionally 'defib' dead patients back to critical."
tips-dataset-246 = Performing CPR on a dead patient will reduce their rot timer, allowing doctors more time to save a patient."
tips-dataset-247 = If you do not take the Latent Psychic trait, you can never be psionic. There may however exist some unusual conditions that can grant this trait during a round."
tips-dataset-248 = You can pick up another person by holding Alt, and left clicking on the person. Your ability to carry them is determined by your relative size!"
tips-dataset-249 = 'Space Wind' is the term for how flowing air can throw objects or people. A hull breach is typically the most common cause of Space Wind, but it can also be caused by high pressure cannons!"
tips-dataset-250 = Ignore firelock warnings at your own peril. You may find yourself being violently thrown into deep space as soon as you crowbar the firelock open."
tips-dataset-251 = There is no friction in space. Unless you use Newton's 1st Law to save yourself, your corpse will float away from the station forever."
tips-dataset-252 = Cloning patients come out of the pod with extremely heavy Cellular damage. Consider using Doxarubixadone in a Cryo tube as an affordable means of 'Finishing' clones."
tips-dataset-253 = Your character's Mood stat influences both your movement speed, and critical injury threshold."
tips-dataset-254 = The Sanguine trait grants your character a permanent large mood bonus. As a result, they often move faster than other people, and will rarely ever take penalties from a net negative mood."
tips-dataset-255 = The Saturnine trait gives your character a permanent large mood penalty. As a result, they often move slower than other people, and can have a hard time getting a net positive mood."
tips-dataset-256 = If you aren't playing any Medical character, consider taking the CPR Training trait! This often highly-underrated trait allows characters to sometimes revive other people without needing medical supplies."
tips-dataset-257 = If you have the Latent Psychic trait, you can consume hallucinogenic drugs to have a chance to obtain psychic powers."
tips-dataset-258 = Having the Natural Telepath trait, or rolling the Telepathy Power, allows a person to speak telepathically by starting a message with '='. Telepathy does not require a radio, but is also completely anonymous."
tips-dataset-259 = You can press the R key to lay down on the ground. While Laying down, you can crawl underneath certain objects. Additionally, bullets will pass harmlessly over someone laying down, unless the shooter targets them directly."
tips-dataset-260 = DO NOT put your money in your PDA
tips-dataset-261 = Izdom, originally a failed supersoldier cloning project, is now used by modern Taypani as a grave insult to one's competence and coherence. The usage of the word is scarce, and often leads to violent killings."